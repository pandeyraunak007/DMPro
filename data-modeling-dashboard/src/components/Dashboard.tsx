              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-1 space-y-3">
                    ...
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-1 mt-1">
                          ...
                          <span className="text-xs text-amber-400">acceptance rate</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="bg-gradient-to-br from-purple-500/20 to-purple-600/10 rounded-lg p-4 border border-purple-500/30">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xl font-bold text-zinc-100">342</p>
                        <div className="flex items-center gap-1 mt-1">
                          <TrendingUp className="w-3 h-3 text-emerald-400" />
                          <span className="text-xs text-emerald-400">+28 this week</span>
                        </div>
                      </div>
                    </div>
                  </div>

                  <div className="bg-gradient-to-br from-rose-500/20 to-rose-600/10 rounded-lg p-4 border border-rose-500/30">
                    <div className="flex items-center gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-xl font-bold text-zinc-100">95%</p>
                        <div className="flex items-center gap-1 mt-1">
                          <Zap className="w-3 h-3 text-rose-400" />
                          <span className="text-xs text-rose-400">this month</span>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="mt-6 pt-6 border-t border-zinc-800">
                    <h3 className="text-xs font-semibold text-zinc-100 mb-3 flex items-center gap-2">
                      <Zap className="w-3 h-3 text-zinc-500" />
                      Quick Access
                    </h3>

                    <div className="grid grid-cols-2 gap-2">
                      <button className="group p-3 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800/50 transition-all duration-200 text-left">
                        <div className="flex items-center gap-2">
                          <div className="p-1 bg-blue-500/10 rounded group-hover:bg-blue-500/20 transition-colors">
                            <HelpCircle className="w-3.5 h-3.5 text-blue-400" />
                          </div>
                          <div className="flex-1">
                            <p className="text-xs font-medium text-zinc-100">Tech Support</p>
                      ...
                      <button className="group p-3 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800/50 transition-all duration-200 text-left">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1">
                            <p className="text-xs font-medium text-zinc-100">Training</p>
                            <p className="text-xs text-zinc-500">Learn more</p>
                          </div>
                        </div>
                      </button>
                      ...
                      <button className="group p-3 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800/50 transition-all duration-200 text-left">
                        <div className="flex items-center gap-2">
                          <div className="p-1 bg-violet-500/10 rounded group-hover:bg-violet-500/20 transition-colors">
                            <Sparkles className="w-3.5 h-3.5 text-violet-400" />
                          </div>
                          <div className="flex-1">
                            <p className="text-xs font-medium text-zinc-100">What's New</p>
                      ...
                      <button className="group p-3 bg-zinc-900 rounded-lg border border-zinc-800 hover:border-zinc-700 hover:bg-zinc-800/50 transition-all duration-200 text-left">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="flex-1">
                            <p className="text-xs font-medium text-zinc-100">Community</p>
